export default class Customizator {
    ...
    onScaleChange(e) {
        ...
        if (e) {
            this.scale = +e.target.value.replace(/x/g, ""); //строку 1x превращается в просто цифру 1
        }
    ...
    render() {
        ...
        scaleInputS.setAttribute('type', 'button'); //input не кликабельный
        scaleInputM.setAttribute('type', 'button');
        scaleInputS.setAttribute('value', '1x'); //значения по дефолту
